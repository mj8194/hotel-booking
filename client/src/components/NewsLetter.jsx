...
const NewsLetter = () => {
  return (
    ...
    <Title title="Stay Inspired" subTitle='Enter your email to receive a monthly dose of curated news, helpful guides, and beautiful stories. No spam—just high-quality content and exclusive updates crafted specifically for our subscribers.'/>
