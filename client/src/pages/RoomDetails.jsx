...
<div className='mt-10'>
  ...
  <div className='flex flex-col md:flex-row md:items-center md:justify-between'>
    ...
    <p className='text-2xl font-medium mt-3 md:mt-0'>
  ...
  <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
   ...
   <div className='w-px h-15 bg-gray-300/70 maax-md:hidden'></div>
    ...
    <div>
        <p className='max-w-3xl  border-y border-gray-300 my-15 py-10 text-gray-500'>Guests will be allocated on the ground floor according to availability.
...
{/* Hosted By */}
    <div className='flex flex-col items-start gap-4'>
        <div className='flex gap-4'>
            <img src="https://images.pexels.com/photos/832998/pexels-photo-832998.jpeg" alt="Host" className='h-14 w-14 md:h-18 md:w-18 rounded-full' />
            <div>
