...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32 '>
       <Title title='My Bookings' subTitle='Manage your upcoming stays and review your past travel history all in one convenient place. Keep track of your itineraries, modify your details, and prepare for your next unforgettable experience with Sthivra.' align='left'/>
       <div className='max-w-6xl mt-8 w-full text-gray-800'>
        
        <div className='hidden md:grid md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 font-medium text-base py-3'>
            <div className='w-'>Hotels</div>
        ...
        {bookings.map((booking)=>(
            <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                ...
                <div className='flex flex-col md:flex-row gap-2'>
                    ...
                    <div className='flex flex-col gap-2 max-md:mt-3 min-md:ml:6'>
